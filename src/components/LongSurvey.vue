  ...
  <div class="row py-5 mx-4">
    ...
    <div class="col-12 col-md-5 py-md-3 mb-3">
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="d" id="inlineRadio3" value="option1" />
        <label class="form-check-label" for="inlineRadio3">Igen</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="d" id="inlineRadio4" value="option2" />
    ...
    <div class="col-12 col-md-5 py-md-3 mb-3">
      <div class="form-row">
        <div class="col-md-6 mb-3">
          <input type="number" class="form-control" id="validationDefault03" placeholder required />
        </div>
      </div>
    </div>
    ...
    <div class="col-12 col-md-5 py-md-3 mb-3">
      <form>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="c" id="inlineRadio5" value="option1" />
          <label class="form-check-label" for="inlineRadio5">Igen</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="c" id="inlineRadio6" value="option2" />
    ...
    <div class="col-12 col-md-5 py-md-3 mb-3">
      <form>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="a" id="inlineRadio7" value="option1" />
          <label class="form-check-label" for="inlineRadio7">Igen</label>
        </div>
        <div class="form-check form-check-inline">
          <input class="form-check-input" type="radio" name="a" id="inlineRadio8" value="option2" />
    ...
    <div class="col-12 col-md-5 py-md-3 mb-3">
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="b" id="inlineRadio9" value="option1" />
        <label class="form-check-label" for="inlineRadio9">Igen</label>
      </div>
      <div class="form-check form-check-inline">
        <input class="form-check-input" type="radio" name="b" id="inlineRadio10" value="option2" />
    ...
    <div class="col-12 col-md-7 py-md-3">
      <p>
        Figyelembe véve a munkakörét és a hozzá tartozó feladatait, mennyire elégett a
        fizetésével?
      </p>
    </div>
    <div class="col-12 col-md-5 py-md-3 mb-3">
    ...
    <div class="col-12 col-md-7 py-md-3">
      <p>
        Ön szerint mennyi tanulás szükséges ahhoz, hogy valaki teljes hatékonysággal tudja az Ön
        munkáját ellátni?
      </p>
    </div>
    <div class="col-12 col-md-5 py-md-3 mb-3">
