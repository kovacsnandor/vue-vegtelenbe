<template>
  <div>
    ...
    <Jumbotron buttonURL="#" buttonText="Tovább a kérdőívekre!">
      <template slot="title">Mennyit keresnék ha...?</template>
      <template
        slot="lead"
      >Lorem ipsum dolor sit amet consectetur adipisicing elit. Molestiae explicabo rerum eveniet porro quaerat ab debitis, atque odio maiores beatae.</template>
    </Jumbotron>
    <main>
        ...
        <div class="row py-5">
          <div class="col-12 col-md-6 col-lg-4 mb-5 mb-md-0 text-center px-4">
            ...
            <p>
              ...
              <span class="font-lg">
                <strong>268%</strong>
              </span>-kal keresnek többet a diplomával nem rendelkezőknél!
            </p>
          </div>
          <div class="col-12 col-md-6 col-lg-4 my-5 my-md-0 text-center px-4">
            ...
            <p>
              ...
              <span class="font-lg">
                <strong>395%</strong>
              </span>-kal keresnek többet az átlagnál!
            </p>
          </div>
          <div class="col-12 col-md-6 col-lg-4 mt-5 mt-md-0 text-center px-4 mx-auto">
            ...
            <p>
              ...
              <span class="font-lg">
                <strong>310%</strong>
              </span>-kal keresnek többet vidéken élő társaikhoz képest!
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-12 col-md-7 my-auto">
              ...
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam alias modi repellendus eos accusantium officiis
                dicta quam minus qui dignissimos.
              </p>
              <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dignissimos officiis, est quam ducimus possimus animi
      ...
      <YoutubeVideoEmbded
        ...
        videoSrc="https://www.youtube.com/embed/FiCtolh3hX4?list=PL4cUxeGkcC9g_69kOfXICzT_hZ79_td99"
      ></YoutubeVideoEmbded>
      <section class="bg-green py-5">
        <div class="container">
...
import YoutubeVideoEmbded from "../components/YoutubeVideoEmbded.vue";
export default {
  components: {
    Jumbotron: Jumbotron,
    YoutubeVideoEmbded: YoutubeVideoEmbded,
  },
};
</script>