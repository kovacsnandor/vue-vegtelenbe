  ...
  <div>
    ...
    <div class="container my-5 pt-5">
      ...
      <div class="row text-justify">
        <div class="col-11 mx-auto mx-sm-0">
          <p class="font-weight-bold text-uppercase">{{post.category}}</p>
        </div>
      </div>
      <div class="row text-justify">
        <div class="col-11 mx-auto mx-sm-0">
      ...
      <div class="row text-justify">
        <div class="col-11 mx-auto mx-sm-0">
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi doloribus, earum, eum aliquam porro repellendus fugiat neque nulla natus consectetur unde quisquam assumenda maxime ipsam accusamus id quo. Eveniet nemo in suscipit debitis repellat
            ...
            temporibus porro earum unde aut labore fugit!
          </p>
        </div>
        <div class="col-11 col-lg-7 text-justify my-auto mx-auto mx-sm-0">
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Recusandae et voluptatem architecto deserunt molestiae, perspiciatis enim optio, nesciunt odit eos eum? Eaque dignissimos tenetur inventore dicta. Vel eveniet atque inventore, asperiores
            ...
            quibusdam, cumque quae debitis, soluta beatae quo, itaque totam repellat eaque.
          </p>
        </div>
        ...
        <div class="col-11 mx-auto mx-sm-0">
          <p class="py-3">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quisquam fuga delectus vitae, iure, est enim tempora aut sint aspernatur nesciunt ipsam placeat officiis natus reiciendis velit dolore veniam ad neque a pariatur voluptas fugiat. Beatae modi
            ...
            maiores debitis, quae quia laborum quidem voluptatibus inventore perspiciatis, ea soluta beatae qui facilis molestias? Molestias eaque, itaque mollitia numquam natus.
          </p>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ratione saepe, possimus fugiat quidem blanditiis quia! Quos maiores quae molestias alias at, ad laboriosam, dicta ex nam quas eveniet beatae repudiandae reiciendis saepe! Est quam ipsum voluptates
            ...
            qui repellendus totam nulla voluptate vero hic ea asperiores voluptatum aut quam error nesciunt culpa? Temporibus earum placeat modi harum tempore officia esse, dolorum voluptates. Corporis nemo vitae in odio obcaecati nesciunt minus aut!
          </p>
        </div>
        <a href="#" title="Facebook" class="btn btn-facebook m-3">
          <img src="../img/like.svg" height="20" alt class="mr-2 mb-1" />Tetszik
        </a>
        <a href="#" title="Facebook" class="btn btn-facebook m-3">
          <img src="../img/facebook.svg" height="20" alt class="mr-2 mb-1" />Megosztom
        </a>
      </div>
    </div>
    ...
    <!-- <div class="container my-5">
      <div class="media">
        <img class="img-fluid" src="img/profil.png" alt="Generic placeholder image" width="60" />
